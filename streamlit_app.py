...
genai.configure(api_key="AIzaSyC-KdiUjOW11dnNCPOZ0IG6rcvIegT3EFc")
...
input=st.text_input("What dou you want me to do?",key="input")
...
input_prompt="""
    ...
    and you will have to answer any type of questions that the user asks you. You have
    to greet the user first.Make sure to keep the fonts uniform and give the items list
    in a point-wise format.
    At the end,make sure to repeat the name of out app "Robobill" and ask the user to use
    it again.
"""  
